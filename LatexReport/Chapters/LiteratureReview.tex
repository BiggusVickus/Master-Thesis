...
The larger $S_i$ is, and the larger the difference $T$ is from $T_{ref_i}$, the stronger the effect will have on the growth rate of $r_i$. 
...
After choosing the parameter values, an output is created, with four sample plots shown in \Cref{fig:cocktail_plot}
...
\Cref{fig:phadedyn_plot} shows the output that PhageDyn provides. 
