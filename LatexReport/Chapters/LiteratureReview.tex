...
Genetic material from one bacteria can be transferred to other bacterial cells via phages, driving bacterial evolution.  e
...
Numerous interactions are occurring between agents in a microbial environmen
...
Cocktail and PhageDyn however have limitations. 
...
The code for Cocktail is open source, so adding new buttons and input fields should not pose a significant challenge, but a time commitment will be required. 
