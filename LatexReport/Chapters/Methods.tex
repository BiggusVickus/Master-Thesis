...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{Screenshots/AdvancedVisualization/phase_portrait_settings.png}
    \caption{
    }
...
SOBOL analysis, a variance-based sensitivity analysis, is a method that allows a user to quantify how important an input parameter has on a measured aspect of the output. 
SOBOl can quantify how much variance is due to a specific parameter. 
\begin{figure}
    \centering
