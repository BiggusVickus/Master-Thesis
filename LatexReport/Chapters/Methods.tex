...
Additionally, the solver is instructed to incorporate $2\cdot M$ supplementary state variables corresponding to the infected states.
...
The next step is to simulate more complex models using the Ultimate Analysis section, where it is possible to implement your own visualizations. 
