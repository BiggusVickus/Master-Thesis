...
\label{sec:SOBOL_sensitivity_ananlysis}
...
\begin{figure}
    ...
    \end{subfigure}
    \caption{The default SOBOL analysis from the dashboard for the $1\times 1 \times 1$ golden model. Data was saved from the dashboard and replotted using Matplotlib. The values used for this SOBOL test can be found in \ref{tab:appendixE:SOBOL_analysis_values}}
    \label{fig:created:SOBOL_1}
\end{figure}
...
\begin{figure}
    ...
    \begin{subfigure}{0.49\linewidth}
        ...
        \end{subfigure}
    \caption{The default SOBOL analysis from the dashboard for the $1\times 1 \times 1$ golden model. The SOBOL data was saved from the dashboard and a custom SOBOL analysis was created. The values used for this SOBOL test can be found in \ref{tab:appendixE:SOBOL_analysis_values}
    }
    \label{fig:created:SOBOL_2}
\end{figure}
