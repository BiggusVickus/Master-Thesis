...
The maximum bacterial population sum varied from 55 to 3106 total bacteria, representing a 56.5-fold difference. \Cref{fig:created:IVA_IVAtable_resource}. 
...
The graph network used can be found in \Cref{fig:ss:example_network}, with the default parameter values listed in \Cref{tab:appendixE:complex_model}. 
...
A visualization of which phages can infect which bacteria and which bacteria can consume which resources can be seen in the $3 \times 2\times 3$ model in \Cref{fig:ss:example_network}. $P_0$ infects $B_1$, $P_1$ infects $B_0$, and $P_2$ infects $B_0$ and $B_1$. 
