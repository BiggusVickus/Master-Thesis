...
\begin{figure}
    ...
    \caption{
        ...
        The same data used in \Cref{fig:created:SOBOL_final} was used for \Cref{fig:created:SOBOL_peak} and \Cref{fig:created:SOBOL_peak_time}. 
...
To create the custom SOBOL analyses, the peak value and the time of the peak of the population is measured and analyzed. 
...
The results of the SOBOL peak and time of peak analyses can be seen in \Cref{fig:created:SOBOL_peak} and \Cref{fig:created:SOBOL_peak_time}. 
Although some of the bars between the final, peak, and time of peak values are the same, some are different. 
But overall, similar values can be seen across the the final, peak, and time of peak analyses. 
...
The time of peak values have less error compared to the final and peak value. 
This is due to the restricted range of vlaues. The time of peak value can only fall somewhere between 0 and 15, the start and end values of the simulation respectively. 
The final and peak values can fall anywhere between 0 and any value, depending on the initial condition and how high the 