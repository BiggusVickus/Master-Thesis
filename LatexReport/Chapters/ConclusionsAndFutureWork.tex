...
The model can be further extended by accounting for temeprature, pH, more interactions between other agents, ther constant addition and removal of other agents, and other considerations. 
