...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{l l l l}
        \toprule
        Other Data\\
        \textbf{Seed Value} & \textbf{2nd Order} & \textbf{Number Samples} & \textbf{Simulations Run}\\
        \midrule
        0 & False & 15 & $2^{15}(11+2) = 425984$\\
        \bottomrule
    \end{tabularx}\newline
    \caption{
        The parameter values used for the SOBOL sensitivity analysis in \Cref{fig:created:SOBOL_1} and \Cref{fig:created:SOBOL_2}. 
    }
