...
\begin{table}[ht!]
    ...
    \end{tabularx}\newline
    \caption{
        The parameter values used for the SOBOL sensitivity analysis in \Cref{fig:created:SOBOL_analyses}, \Cref{fig:created:SOBOL_extra} and \Cref{fig:created:SOBOL_no_wi_wo}. 
    }
