...
\begin{figure}
    ...
    \begin{subfigure}{1\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/Created/initial_value_analysis_Phages_95.png}
        \caption{
    ...
    \begin{subfigure}{1\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/Created/initial_value_analysis_Phages_100.png}
        \caption{
    ...
    \begin{subfigure}{1\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/Created/initial_value_analysis_Uninfected_Bacteria_95.png}
        \caption{
    ...
    \begin{subfigure}{1\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/Created/initial_value_analysis_Uninfected_Bacteria_100.png}
        \caption{
    ...
    \begin{subfigure}{1\linewidth}
        \centering
        \includegraphics[width=\linewidth]{Plots/Created/initial_value_analysis_Uninfected_Bacteria_100_own_time.png}
        \caption{
