...
\begin{figure}[]
    \includegraphics[width=1\textwidth]{Plots/Created/UA/tau_beta_washout_0.02.png}
    \centering
    \caption{
...
\begin{figure}[]
    \includegraphics[width=1\textwidth]{Plots/Created/UA/tau_beta_washout_0.05.png}
    \centering
    \caption{
